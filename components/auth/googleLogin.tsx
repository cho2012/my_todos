        ...
        <div className="w-64">
          {loading ? (
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 px-4 py-3 text-gray-700 border rounded-full hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-200 transition-colors"
            >
              <svg
